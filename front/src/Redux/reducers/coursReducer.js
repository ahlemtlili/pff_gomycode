import { DELETE_COURS_FAIL,  GET_COURS_FAIL, GET_COURS_LOADING, GET_COURS_SUCCESS, GET_ONE_COURS_FAIL, GET_ONE_COURS_SUCCESS, UPDATE_ONE_COURS_FAIL } from "../constants/coursTypes";
